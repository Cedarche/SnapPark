...
export default function Footer() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const addToNewsletterList = httpsCallable<
        { email: string },
        AddToAppLaunchListResponse
      >(functions, "addToNewsletterList");
      const result = addToNewsletterList({ email });
      console.log(result)
  ...
  return (
    <>
      <footer className="bg-slate-800" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-10 sm:pt-14 lg:px-8 lg:pt-10">
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-14 md:flex md:items-center md:justify-between lg:mt-10">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; {new Date().getFullYear()} SNAP PARK. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
